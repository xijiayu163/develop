...
public class ProxyDirContext implements DirContext {
    ...
    public String toString2(int tNumber){
    	...
    	sb.append(tStr+"HOST:"+ProxyDirContext.HOST+"\r\n");
    	sb.append(tStr+"proxy:"+this.proxy+"\r\n");
    	for(String envKey:env.keySet()){
    		sb.append(tStr+"envKey:"+envKey+"\r\n");
    		sb.append(tStr+"env:"+this.env.get(envKey)+"\r\n");
    	}
    	sb.append(tStr+"dirContext:"+this.dirContext+"\r\n");
    	sb.append(tStr+"vPath:"+this.vPath+"\r\n");
    	sb.append(tStr+"hostName:"+this.hostName+"\r\n");
    	sb.append(tStr+"contextName:"+this.contextName+"\r\n");
    	sb.append(tStr+"contextPath:"+this.contextPath+"\r\n");
    	sb.append(tStr+"cacheClassName:"+this.cacheClassName+"\r\n");
    	sb.append(tStr+"cache:"+this.cache+"\r\n");
    	sb.append(tStr+"cacheTTL:"+this.cacheTTL+"\r\n");
    	sb.append(tStr+"cacheObjectMaxSize:"+this.cacheObjectMaxSize+"\r\n");
    	for(String nonCache:nonCacheable){
    		sb.append(tStr+"nonCache:"+nonCache+"\r\n");
    	}
