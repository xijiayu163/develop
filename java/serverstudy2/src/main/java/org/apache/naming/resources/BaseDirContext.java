...
public abstract class BaseDirContext implements DirContext {
	...
	public String toString2(int tNumber) {
    	...
    	sb.append(tStr+"docBase:"+this.docBase+"\r\n");
    	for(String envKey:env.keySet()){
    		sb.append(tStr+"envKey:"+envKey+"\r\n");
    		sb.append(tStr+"env:"+this.env.get(envKey)+"\r\n");
    	}
    	sb.append(tStr+"nameParser:"+this.nameParser+"\r\n");
    	sb.append(tStr+"cached:"+this.cached+"\r\n");
    	sb.append(tStr+"cacheTTL:"+this.cacheTTL+"\r\n");
    	sb.append(tStr+"cacheTTL:"+this.cacheMaxSize+"\r\n");
    	sb.append(tStr+"cacheTTL:"+this.cacheObjectMaxSize+"\r\n");
    	for(String aliaseKey:aliases.keySet()){
    		sb.append(tStr+"aliaseKey:"+aliaseKey+"\r\n");
    		sb.append(tStr+"aliasDirContext:"+this.aliases.get(aliaseKey)+"\r\n");
    	}
    	for(DirContext altDirContext:altDirContexts){
    		sb.append(tStr+"altDirContext:"+altDirContext+"\r\n");
    	}
