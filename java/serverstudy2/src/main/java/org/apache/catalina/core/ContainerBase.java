...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    private final org.apache.juli.logging.Log log=
        org.apache.juli.logging.LogFactory.getLog(this.getClass());
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        log.info("即将开启子线程启动孩子容器...孩子容器个数:"+children.length);
        for (int i = 0; i < children.length; i++) {
        	log.info("child "+(i+1)+" class"+":"+children[i].getClass().getName());
        }
	...
	public String toString2(int tNumber) {
    	...
    	if(this.getLoader()!=null){
    		sb.append(tStr+"loader================>>\r\n");
    		sb.append(this.getLoader().toString2(tNumber));
    	}else{
    		sb.append(tStr+"loader:null\r\n");
    	}
    	
    	sb.append(tStr+"logName:"+this.logName+"\r\n");
    	sb.append(tStr+"name:"+this.getName()+"\r\n");
    	if(this.parent!=null){
    		sb.append(tStr+"parent container:"+this.parent.getClass().getName()+"\r\n");
    	}else{
    		sb.append(tStr+"parent container:null\r\n");
    	}
    	sb.append(tStr+"parentClassLoader:"+LogHelper.printClassLoader(this.parentClassLoader));
    	sb.append(tStr+"thread:"+thread+"\r\n");
    	sb.append(tStr+"threadDone:"+this.threadDone+"\r\n");
    	sb.append(tStr+"startStopThreads:"+this.getStartStopThreads()+"\r\n");
    	sb.append(tStr+"startStopThreadInternal:"+this.getStartStopThreadsInternal()+"\r\n");
    	sb.append(tStr+"resources dir context================>>\r\n");
    	sb.append(((ProxyDirContext)this.getResources()).toString2(tNumber));
    	sb.append(tStr+"pipeline================>>\r\n");
    	sb.append(((StandardPipeline)this.getPipeline()).toString2(tNumber));
    	for(ContainerListener listener:this.listeners){
    		sb.append(tStr+"listener[container Listener]:"+listener.getClass().getName()+"\r\n");
    	}
    	if(this.findChildren()!=null){
    		for(Container container:this.findChildren()){
    			sb.append(tStr+"child container================>>\r\n");
    			sb.append(container.toString2(tNumber));
    		}
    	}else{
    		sb.append(tStr+"children containers:null\r\n");
    	}
    	return sb.toString();
	}
	
//	public HashMap<String, Container> getChildrenContainer(){
//		return children;
//	}
}
