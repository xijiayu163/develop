...
public class WebappLoader extends LifecycleMBeanBase
    ...
    public String toString2(int tNumber) {
    	...
    	sb.append(tStr+"first:"+WebappLoader.first+"\r\n");
    	sb.append(tStr+"classLoader:"+LogHelper.printClassLoader(this.getClassLoader()));
    	sb.append(tStr+"delegate:"+this.getDelegate()+"\r\n");
    	sb.append(tStr+"info:"+this.getInfo()+"\r\n");
    	sb.append(tStr+"loadClass:"+this.getLoaderClass()+"\r\n");
    	...
    	for(String repository:repositories){
    		sb.append(tStr+"repository:"+repository+"\r\n");
    	}
    	sb.append(tStr+"classpath:"+this.getClasspath()+"\r\n");
    	if(loaderRepositories!=null){
    		for(String loaderRepository:loaderRepositories){
    			sb.append(tStr+"loaderRepository:"+loaderRepository+"\r\n");
    		}
    	}else{
    		sb.append(tStr+"loaderRepository:null"+"\r\n");
    	}
    	sb.append(tStr+"searchExternalFirst:"+this.getSearchExternalFirst()+"\r\n");
    	
        if (container != null)
            sb.append(tStr+"container:"+container.getClass().getName()+"\r\n");
