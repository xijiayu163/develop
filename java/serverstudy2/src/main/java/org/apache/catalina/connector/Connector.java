...
public class Connector extends LifecycleMBeanBase  {
	...
	public String toString2(int tNumber) {
		...
		sb.append(tStr+"service:"+service.getClass().getName()+"\r\n");
		sb.append(tStr+"allowTrace:"+allowTrace+"\r\n");
		sb.append(tStr+"asyncTimeout:"+asyncTimeout+"\r\n");
		sb.append(tStr+"enableLookups:"+enableLookups+"\r\n");
		sb.append(tStr+"xpoweredBy:"+xpoweredBy+"\r\n");
		sb.append(tStr+"info:"+info+"\r\n");
		sb.append(tStr+"port:"+port+"\r\n");
		sb.append(tStr+"proxyName:"+proxyName+"\r\n");
		sb.append(tStr+"proxyPort:"+proxyPort+"\r\n");
		sb.append(tStr+"redirectPort:"+redirectPort+"\r\n");
		sb.append(tStr+"scheme:"+scheme+"\r\n");
		sb.append(tStr+"secure:"+secure+"\r\n");
		sb.append(tStr+"maxParameterCount:"+maxParameterCount+"\r\n");
		sb.append(tStr+"maxPostSize:"+maxPostSize+"\r\n");
		sb.append(tStr+"maxSavePostSize:"+maxSavePostSize+"\r\n");
		sb.append(tStr+"parseBodyMethods:"+parseBodyMethods+"\r\n");
		for(String parseBodyMethod:parseBodyMethodsSet){
			sb.append(tStr+"parseBodyMethod:"+parseBodyMethod+"\r\n");
		}
		sb.append(tStr+"useIPVHosts:"+useIPVHosts+"\r\n");
		sb.append(tStr+"protocolHandlerClassName:"+protocolHandlerClassName+"\r\n");
		sb.append(tStr+"protocolHandler:"+protocolHandler+"\r\n");
		sb.append(tStr+"mapper================>>\r\n");
		sb.append(mapper.toString2(tNumber)+"\r\n");
		sb.append(tStr+"mapperListener:"+mapperListener+"\r\n");
		sb.append(tStr+"URIEncoding:"+URIEncoding+"\r\n");
		sb.append(tStr+"useBodyEncodingForURI:"+useBodyEncodingForURI+"\r\n");
		for(String replacement:replacements.keySet()){
			sb.append(tStr+"replacementKey:"+replacement+"\r\n");
			sb.append(tStr+"replacement:"+replacement+"\r\n");
		}
