...
public class StandardHost extends ContainerBase implements Host {
    ...
    public String toString2(int tNumber) {
    	...
    	for(String alias:aliases){
    		sb.append(tStr+"alias:"+alias+"\r\n");
    	}
    	sb.append(tStr+"appBase:"+this.getAppBase()+"\r\n");
    	sb.append(tStr+"xmlBase:"+this.getXmlBase()+"\r\n");
    	sb.append(tStr+"autoDeploy:"+this.getAutoDeploy()+"\r\n");
    	sb.append(tStr+"configClass:"+this.getConfigClass()+"\r\n");
    	sb.append(tStr+"contextClass:"+this.getContextClass()+"\r\n");
    	sb.append(tStr+"deployOnStartup:"+this.getDeployOnStartup()+"\r\n");
    	sb.append(tStr+"deployXML:"+this.isDeployXML()+"\r\n");
    	sb.append(tStr+"copyXML:"+this.isCopyXML()+"\r\n");
    	sb.append(tStr+"errorReportValveClass:"+this.getErrorReportValveClass()+"\r\n");
    	sb.append(tStr+"info:"+this.getInfo()+"\r\n");
    	sb.append(tStr+"unpackWARs:"+this.isUnpackWARs()+"\r\n");
    	sb.append(tStr+"workDir:"+this.getWorkDir()+"\r\n");
    	sb.append(tStr+"createDirs:"+this.getCreateDirs()+"\r\n");
    	for(ClassLoader classLoader:this.childClassLoaders.keySet()){
    		sb.append(tStr+"child classLoader name:"+this.childClassLoaders.get(classLoader)+"\r\n");
    		sb.append(tStr+"child classLoader:"+LogHelper.printClassLoader(classLoader)+"\r\n");
    	}
    	sb.append(tStr+"deployIgnorePattern:"+this.getDeployIgnorePattern()+"\r\n");
    	sb.append(tStr+"deployIgnore:"+this.getDeployIgnore()+"\r\n");
    	sb.append(tStr+"failCtxIfServletStartFails:"+this.isFailCtxIfServletStartFails()+"\r\n");
    	sb.append(tStr+"undeployOldVersions:"+this.getUndeployOldVersions()+"\r\n");
