...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public String toString2(int tNumber) {
        ...
        sb.append(tStr+"taddress:"+this.getAddress()+"\r\n");
        sb.append(tStr+"domain:"+this.getDomain()+"\r\n");
        sb.append(tStr+"domainInternal:"+this.getDomainInternal()+"\r\n");
        sb.append(tStr+"info:"+this.getInfo()+"\r\n");
        sb.append(tStr+"port:"+this.getPort()+"\r\n");
        sb.append(tStr+"serverBuilt:"+this.getServerBuilt()+"\r\n");
        sb.append(tStr+"serverInfo:"+this.getServerInfo()+"\r\n");
        sb.append(tStr+"serverNumber:"+this.getServerNumber()+"\r\n");
        sb.append(tStr+"shutDown:"+this.getShutdown()+"\r\n");
        sb.append(tStr+"stateName:"+this.getStateName()+"\r\n");
        sb.append(tStr+"parentClassLoader:"+LogHelper.printClassLoader(this.getParentClassLoader()));
        sb.append(tStr+"life cycle state:"+this.getState()+"\r\n");
        for(Service service:this.services){
        	sb.append(tStr+"service================>>\r\n");
        	sb.append(((StandardService)service).toString2(++tNumber)+"\r\n");
        }
    ...
    protected void startInternal() throws LifecycleException {
    	log.debug("触发监听器生命周期事件...");
        fireLifecycleEvent(CONFIGURE_START_EVENT, null);
        log.debug("触发监听器生命周期事件完成");
        ...
        synchronized (servicesLock) {
            for (int i = 0; i < services.length; i++) {
            	log.debug("service 启动...");
                services[i].start();
                log.debug("service 启动完成");
            }
        }
    }
