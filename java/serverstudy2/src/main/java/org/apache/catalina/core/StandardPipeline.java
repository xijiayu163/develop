...
public class StandardPipeline extends LifecycleBase
    ...
    public String toString2(int tNumber){
    	...
    	sb.append(tStr+"container class:"+container.getClass().getName()+"\r\n");
    	sb.append(tStr+"info:"+this.getInfo()+"\r\n");
    	sb.append(tStr+"first valve================>>\r\n");
    	sb.append(this.getFirst().toString2(tNumber));
    	sb.append(tStr+"basic valve================>>\r\n");
    	sb.append(this.getBasic().toString2(tNumber));
    	Valve valve = this.getFirst();
    	int i=1;
    	sb.append(tStr+"valve"+i+"================>>\r\n");
    	sb.append(valve.toString2(tNumber));
    	while(true){
    		valve = valve.getNext();
    		if(valve==null){
    			break;
