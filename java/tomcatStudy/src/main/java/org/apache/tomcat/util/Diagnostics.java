...
public class Diagnostics {
	private static Log log = LogFactory.getLog(Diagnostics.class);
     ...
     * 打印虚拟机工作信息
     */
    public static void testGetVMInfo(){
    	Locale defaultLocale = Locale.getDefault();
    	ArrayList<Locale> results = new ArrayList<Locale>();
        results.add(defaultLocale);
        Enumeration<Locale> enumeration = Collections.enumeration(results);
		String vmInfo = Diagnostics.getVMInfo(enumeration);
		log.info(vmInfo);
    }
     ...
     * 获得线程转储信息(threaddump)
     */
    public static void testGetThreadDump(){
    	Locale defaultLocale = Locale.getDefault();
    	ArrayList<Locale> results = new ArrayList<Locale>();
        results.add(defaultLocale);
        Enumeration<Locale> enumeration = Collections.enumeration(results);
    	String threadDump = getThreadDump(enumeration);
    	log.info(threadDump);
    }
}
