...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.yu.webservice.endpoint.wsimport.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.yu.webservice.endpoint.wsimport.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns com.yu.webservice.endpoint.wsimport.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.yu.webservice.endpoint.wsimport.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.yu.webservice.endpoint.wsimport.GetDatabaseInfoResponse")
